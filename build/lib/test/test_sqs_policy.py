...
class TestSqs(unittest.TestCase):
    ...
    def test_sqs_policy(self):
          ...
          template_name = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))+'/terraform_validator/test_templates/tf/sqs_queue_policy/sqs_policy_with_not_action.tf'
          debug = True
