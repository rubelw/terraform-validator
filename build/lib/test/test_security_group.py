...
class TestSecurityGroup(unittest.TestCase):
    ...
    def test_dangling_egress_rule(self):
        expected_result = [
            {
                'failure_count': '1',
                'filename': '/tf/security_group/dangling_egress_rule.tf',
                'file_results': [
                    {
                        'id': 'FATAL',
        ...
        template_name = os.path.dirname(os.path.dirname(
            os.path.realpath(__file__))) + '/terraform_validator/test_templates/tf/security_group/dangling_egress_rule.tf'
        debug = True
    ...
    def test_security_group_missing_properties(self):
        ...
        expected_result = [
            {
                'failure_count': '1',
                'filename': '/tf/security_group/sg_missing_properties.tf',
                'file_results': [
                    {
                        'id': 'FATAL',
                        'type': 'VIOLATION::FAILING_VIOLATION',
        ...
        template_name = os.path.dirname(os.path.dirname(
            os.path.realpath(__file__))) + '/terraform_validator/test_templates/tf/security_group/sg_missing_properties.tf'
        debug = True
    ...
    def test_security_group_when_egress_is_empty(self):
        expected_result = [
            {
                'failure_count': '1',
                'filename': '/tf/security_group/single_security_group_empty_ingress.tf',
                'file_results': [
                    {
                        'id': 'F1000',
                        'type': 'VIOLATION::FAILING_VIOLATION',
    ...
    def test_security_group_when_inline_sg_is_open_to_world(self):
        expected_result = [
            {
                'failure_count': '2',
                'filename': '/tf/security_group/two_security_group_two_cidr_ingress.tf',
                'file_results': [
                    {
                        'id': 'F1000',
                        'type': 'VIOLATION::FAILING_VIOLATION',
    ...
    def test_security_group_when_has_multiple_inline_egress_rules(self):
        expected_result = [
            {
                'failure_count': '0',
                'filename': '/tf/security_group/multiple_inline_egress.tf',
                'file_results': [
                ]
            }
        ]
    ...
    def test_two_security_groups_ingress_standalone_with_non32_cidr(self):
        expected_result = [
            {
                'failure_count': '0',
                'filename': '/tf/security_group/non_32_cidr_standalone_ingress.tf',
                'file_results': [
                    {
                        'id': 'W9',
                        'type': 'VIOLATION::WARNING',
    ...
    def test_two_security_groups_with_non32_cidr(self):
        expected_result = [
            {
                'failure_count': '0',
                'filename': '/tf/security_group/non_32_cidr.tf',
                'file_results': [
                    {
                        'id': 'W9',
                        'type': 'VIOLATION::WARNING',
    ...
    def test_multiple_security_groups(self):
      ...
      expected_result = [
            {
                'failure_count': '0',
                'filename': '/tf/security_group/multiple_ingress_security_groups.tf',
                'file_results': [
                    {
                        'id': 'W5',
                        'type': 'VIOLATION::WARNING',
