...
class TestS3(unittest.TestCase):
    ...
    def test_s3_no_tags(self):
      ...
      expected_result =  [
            {
                'failure_count': '1',
                'filename': '/tf/s3_bucket/no_tags.tf',
                'file_results': [
                    {
                        'id': 'F87',
      ...
      template_name = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))+'/terraform_validator/test_templates/tf/s3_bucket/no_tags.tf'
      debug = True
    ...
    def test_s3_missing_tags(self):
      ...
      expected_result = [
            {
                'failure_count': '1',
                'filename': '/tf/s3_bucket/missing_one_required_tags.tf',
                'file_results': [
                    {
                        'id': 'F87',
                        'type': 'VIOLATION::FAILING_VIOLATION',
      ...
      template_name = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))+'/terraform_validator/test_templates/tf/s3_bucket/missing_one_required_tags.tf'
      debug = False
